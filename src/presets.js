...
export const createLogoLayer = (index, overrides = {}) => ({
  ...
  blur: 0,
  assetSrc: overrides.assetSrc ?? '/logos/dwd-digilab-ai-gelb.svg',
  assetName: overrides.assetName ?? 'digilab.ai Gelb',
  transform: {
    x: overrides.x ?? 0.2,
    y: overrides.y ?? 0.12,
    rotation: overrides.rotation ?? 0,
